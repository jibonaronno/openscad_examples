...
//After creation of this object, the parameters of the box can
//be retrive by various function defined in 
...
move([50, 30, 0]) box_corner_profile_section(box, 2, 3);
move([80, 30, 0]) box_corner_profile(box);
move([80, 50, 0]) box_bezel(box, false);
//move([75, 30, 0]) box_corner_profile_section(box, 2, 3);
